...
const navItems: NavItem[] = [
  { href: '/dashboard', label: 'Home', icon: LayoutDashboard, permission: Permission.VIEW_DASHBOARD },
  {
    ...
    children: [
      { href: '/inbox/unificado', label: 'Unificado', icon: MessageCircle, iconSrc: '/icons/unified-mono.svg', permission: Permission.VIEW_INBOX },
      { href: '/inbox/whatsapp', label: 'WhatsApp', icon: MessageSquare, iconSrc: '/icons/whatsapp-mono.svg', permission: Permission.VIEW_INBOX },
      { href: '/inbox/instagram', label: 'Instagram', icon: Instagram, iconSrc: '/icons/instagram-mono.svg', permission: Permission.VIEW_INBOX },
    ],
  },
